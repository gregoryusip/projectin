        ...
        <form action="/dashboard/jobs/{{ $job->slug }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="row mb-3">
                <div class="col-md-6 mb-3 mb-lg-0">
                    ...
                    <input type="text" class="form-control @error('title') is-invalid @enderror" id="title" name="title" value="{{ old('title', $job->title) }}" aria-describedby="title" required>
                ...
                <div class="col-md-6 mb-lg-0">
                    ...
                    <input type="text" class="form-control @error('slug') is-invalid @enderror" id="slug" name="slug" value="{{ old('slug', $job->slug) }}" aria-describedby="slug" readonly>
            ...
            <div class="row mb-3">
                <div class="col-md-6 mb-3 mb-lg-0">
                    ...
                    <input type="text" class="form-control @error('job_style') is-invalid @enderror" id="job_style" name="job_style" value="{{ old('job_style', $job->job_style) }}" aria-describedby="job_style" required>
                ...
                <div class="col-md-6 mb-lg-0">
                    ...
                    <input type="text" class="form-control @error('file_format') is-invalid @enderror" id="file_format" name="file_format" value="{{ old('file_format', $job->file_format) }}" aria-describedby="file_format" required>
            ...
            <div class="row mb-3">
                <div class="col-md-6 mb-3 mb-lg-0">
                    ...
                    <input type="text" class="form-control @error('package_name') is-invalid @enderror" id="package_name" name="package_name" value="{{ old('package_name', $job->package_name) }}" aria-describedby="package_name" required>
                ...
                <div class="col-md-3 mb-3 mb-lg-0">
                    ...
                    <input type="text" class="form-control @error('job_delivery') is-invalid @enderror" id="job_delivery" name="job_delivery" value="{{ old('job_delivery', $job->job_delivery) }}" aria-describedby="job_delivery" required>
                ...
                <div class="col-md-3 mb-lg-0">
                    ...
                    <input type="text" class="form-control @error('revision') is-invalid @enderror" id="revision" name="revision" value="{{ old('revision', $job->revision) }}" aria-describedby="revision" required>
            ...
            <div class="row mb-3 align-items-center">
                <div class="col-md-6 mb-lg-0">
                    ...
                    <textarea class="form-control @error('package_description') is-invalid @enderror" id="package_description" name="package_description" aria-describedby="package_description" rows="3" required>{{ old('package_description', $job->package_description) }}</textarea>
            ...
            <div class="row mb-5">
                <div class="col-md-6 mb-3 mb-lg-0">
                    ...
                    <div class="input-group mb-3">
                        ...
                        <input type="text" class="form-control @error('price') is-invalid @enderror" id="price" name="price" value="{{ old('price', $job->price) }}" aria-describedby="price" required>
                    </div>
